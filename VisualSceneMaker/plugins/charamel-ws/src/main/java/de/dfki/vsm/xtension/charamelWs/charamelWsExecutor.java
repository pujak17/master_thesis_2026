...
public class charamelWsExecutor extends ActivityExecutor {
    ...
    private void parseAction(String name, LinkedList<ActionFeature> f) {
        switch (name) {
            case "applause": {
                broadcast(new TimeLine(new ApplauseCommand()));
                break;
            }
            case "angry": {
            ...
            case "comein": {
                ...
                broadcast(new TimeLine(new ComeInCommand(direction)));
                break;
            }
            ...
            case "emphasiswholething": {
                broadcast(new TimeLine(new EmphasisWholeThingCommand()));
                break;
            }
            case "explain": {
                String numberString = getActionFeatureValue("number", f);
            ...
            case "greet1": {
                broadcast(new TimeLine(new Greet1Command()));
                break;
            }
            case "hairback": {
            ...
            case "lookatdown": {
                broadcast(new TimeLine(new LookAtDownCommand()));
                break;
            }
            case "lookleft": {
            ...
            case "lookdown": {
                broadcast(new TimeLine(new LookLeftDownCommand()));
                break;
            }
            case "lookscreenleft": {
                broadcast(new TimeLine(new LookScreenLeftCommand()));
                break;
            }
            case "luemmeln": {
            ...
            case "mouthround": {
                String intensityStr = getActionFeatureValue("intensity", f);
                EmotionCommand hc = new EmotionCommand("phon_a", (intensityStr.isEmpty()) ? 0.7f : Float.parseFloat(intensityStr));
                broadcast(hc);
                break;
            }
            case "nod": {
            ...
            case "pointdownmiddle": {
                broadcast(new TimeLine(new PointDownMiddle()));
                break;
            }
            ...
            case "sigh": {
                broadcast(new TimeLine(new SighCommand()));
                break;
            }
            case "sitbrave": {
            ...
            case "sittable": {
                broadcast(new TimeLine(new SitTableCommand()));
                break;
            }
            case "sittablechin": {
                broadcast(new TimeLine(new SitTableChinCommand()));
                break;
            }
            case "sitnodd": {
            ...
            case "screenshow": {
                broadcast(new TimeLine(new ScreenShowCommand()));
                break;
            }
            case "sequence": {
            ...
            case "thinkrightdown": {
                broadcast(new TimeLine(new ThinkRightDownCommand()));
                break;
            }
        }
    }
